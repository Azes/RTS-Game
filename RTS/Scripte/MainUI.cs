...
public class MainUI : MonoBehaviour
{
    ...
    bool checkIsSingel()
    {
        ...
        else
        {
            ...
            if (humans.Count > 0)
            {
                ...
                else if (humans[0] is Heiler) singleIndex = 3;//new
    ...
    void isListValueChange(bool it)
    {
        if (it)
        {
            ...
            //old way
            //wir gehen die child objecte in GroupCeontent
            //von unten nach oben durch um alle sicher zu löschen
            //for (int i = GroupContent.childCount - 1; i >= 0; i--)
            //    Destroy(GroupContent.GetChild(i).gameObject);
            //
            ////fügt die EinheitBar objecte der Group hinzu
            //for (int i = 0; i < humans.Count; i++)
            //{
    ...
    void sortedList()
    {
        ...
        if (!sorted)
        {
            ...
            else
            {
                ...
                //}
                //
                //// Setze die sortierte Reihenfolge der Objekte in den entsprechenden Containern zurück
        ...
        else
        {
            ...
            //     {
            //         //new
            //         if (scriptA is Heiler && !(scriptB is Heiler))
            //         {
            //             return -1;
            //         }
            //         else if (scriptA is Heiler && !(scriptB is Heiler))
            //         {
            //             return 1;
            //         }
            //         else if (scriptA is Villager && !(scriptB is Villager))
            //         {
            //             return -1;
            //         }
            ...
            //    List<Transform> heiler = new List<Transform>();//new 
            //
            //    foreach (Transform child in children)
            //    {
            //        IHuman script = child.GetComponent<EinheitBar>().ih.GetComponent<IHuman>();
            ...
            //        heiler.Sort((a, b) => a.GetComponent<EinheitBar>().value.CompareTo(b.GetComponent<EinheitBar>().value));//new
            //    }
            //    else if (order == 2)
            //    {
            ...
            //        heiler.Sort((a, b) => b.GetComponent<EinheitBar>().value.CompareTo(a.GetComponent<EinheitBar>().value));//new
            //    }
            //
            //    int currentIndex = 0;
            //    foreach (Transform child in heiler)//new
            //    {
